...
struct ContentView: View {
    var body: some View {
        SwiftUISkia.Surface(width: 360, height: 360) {
            ...
            SwiftUISkia.Image(image: "https://developer.apple.com/assets/elements/icons/swiftui/swiftui-96x96_2x.png", x: 30, y: 40, width: 70, height: 70, blur: 10, grayscale: nil, brighten: 40, invert: nil) {}
            SwiftUISkia.Image(image: "https://developer.apple.com/assets/elements/icons/swiftui/swiftui-96x96_2x.png", x: 0, y: 0, width: 70, height: 70, blur: nil, grayscale: nil, brighten: nil, invert: nil) {}
